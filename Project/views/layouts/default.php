...
<body>
<?php if(\SCart\App::getInstance()->getIsLoggedUser()): ?>
...
<?php
if(\SCart\App::getInstance()->getSession()->messages) {


    foreach (\SCart\App::getInstance()->getSession()->messages as $k => $v) {
        echo "<div class='$v->type'>$v->text</div>";
    }
}
