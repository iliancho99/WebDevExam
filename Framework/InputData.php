...
class InputData {
    ...
    public function get($id, $normalize = null, $default = null) {
        if ($this->hasGet($id)) {
            if ($normalize != null) {
                return \SCart\Common::normalize($this->_get[$id], $normalize);
            }
            return $this->_get[$id];
        }
        return $default;
    ...
    public function post($name, $normalize = null, $default = null) {
        if ($this->hasPost($name)) {
            if ($normalize != null) {
                return \SCart\Common::normalize($this->_post[$name], $normalize);
            }
    ...
    public function cookies($name, $normalize = null, $default = null) {
        if ($this->hasCookies($name)) {
            if ($normalize != null) {
                return \SCart\Common::normalize($this->_cookies[$name], $normalize);
            }
    ...
    /**
     *
     * @return \SCart\InputData
     */
    public static function getInstance() {
        if (self::$_instance == null) {
            self::$_instance = new \SCart\InputData();
        }
